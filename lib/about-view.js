...
// atom.window.isDevMode()/atom.window.isSafeMode() at the global level.
...
module.exports = class AboutView extends EtchComponent {
  ...
  handleReleaseNotesClick(e) {
    e.preventDefault();
    atom.shell.openExternal(this.props.updateManager.getReleaseNotesURLForCurrentVersion());
  }
